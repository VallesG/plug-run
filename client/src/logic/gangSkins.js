...
export const GANG_SKINS=Object.freeze({
  ...
  'iron-row':Object.freeze({name:'Iron Row',body:0x67734c,trim:0xd2c66a,car:0x596744,stripe:0xeee3c5}),
...
export function skinTextureKeys(id){
  ...
  const version=id==='iron-row'?'v2':'v1';
  return {runner:'gang_runner_'+id+'_'+version,step:'gang_runner_'+id+'_step_'+version,car:'gang_car_'+id+'_'+version};
}
