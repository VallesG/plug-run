...
export const CAMPAIGN_CADENCE_BANTER = Object.freeze({
 crossline:Object.freeze([
  ...
  [{speaker:'switch',text:"Mags plans his grocery route on the whiteboard. With a protractor."}],
 ...
 'iron-row':Object.freeze([
  ...
  [{speaker:'rook',text:"Brick asked me to label things better. I labeled his coffee mug MINE, DO NOT TOUCH, SERIOUSLY."}],
