...
- the Normal bank: `client/public/rivals/jev-v1/` holds 328 races, 16 on
  each of courses 1-20 and 8 on course 21 (the first 41 sealed jobs of
  `tools/plans/jev-v1.json`, assembled with `--fresh`, zero rejections, `v2`
  unchanged).
