...
### Update PlugAI.js
- [  ] Update `getPlugBaseStats()` with new Round 1 values
- [ ] Rewrite `applyPlugProgression()` with linear formulas
- [ ] Add minimum bounds for fire rate (0.3s)
- [ ] Add minimum bounds for accuracy (0.1 inaccuracy)
- [ ] Add minimum bounds for reaction (100ms)
- [ ] Remove old percentage-based scaling
- [ ] Add comments explaining the progression system
